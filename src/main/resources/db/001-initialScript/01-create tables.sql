...
CREATE TABLE EMPLOYEE (
  ...
  MENTOR_ID INT NULL, 
  IS_LINE_MANAGER bit DEFAULT 0,
  IS_TEAM_LEAD bit DEFAULT 0,
  IS_MENTOR BIT DEFAULT 0,
  CONSTRAINT LINE_MANAGER_FK FOREIGN KEY (LINE_MANAGER_ID) REFERENCES EMPLOYEE (USER_ID),
  CONSTRAINT TEAM_LEAD_FK FOREIGN KEY (TEAM_LEAD_ID) REFERENCES EMPLOYEE (USER_ID),
